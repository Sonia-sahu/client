  ...
  server: {
    proxy: {
      "/api": {
        ...
        changeOrigin: true, //cors issue
        secure: false, //work only in http stops https
      },
    ...
    //in your application wherever u make a call to /api then it will be directed to http://localhost:9500
  },
});
